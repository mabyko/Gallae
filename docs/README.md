...
> 상태: 구현 기준 · 2026-09-01
> 범위: Open & Inspect, Commit, Repository ref History·파일별 patch와 Revert·soft·mixed·hard Reset, local branch 생성·전환·fast-forward Merge·divergent Merge commit·Rebase, Sync, Stash 조회·생성·적용·삭제, HEAD Reflog 조회·복구 branch 생성, 충돌 파일 Base·Ours·Theirs 검사와 한쪽 전체 버전·현재 working tree 내용으로 해결, 진행 중인 Merge·Rebase 상태 검사·Continue·Abort, Interactive Rebase 계획 검사·편집·검토·실행
